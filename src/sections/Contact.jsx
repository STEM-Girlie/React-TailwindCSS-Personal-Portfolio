...
rounded-full blur-3xl"
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 w-full max-w-5xl mx-auto ">
          ...
          {/*contact info*/}
          <div className="space-y-6 animate-fade-in animation-delay-400 mt-30 w-full mx-auto">
            <div className="glass rounded-3xl p-8 border border-primary/30 w-full mx-auto">
